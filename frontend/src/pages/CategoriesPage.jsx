  ...
  return (
    <div className="container mx-auto">
        ...
        <div className="flex items-end gap-4">
          <div className="flex-grow">
            ...
            <input
              ...
              className="mt-1 border border-gray-300 dark:border-gray-600 p-2 rounded w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
              required
            />
          </div>
      ...
      <div className="space-y-3">
        {categories.map(cat => (
          <div key={cat.id} className="flex justify-between items-center p-3 border border-gray-200 dark:border-gray-700 rounded shadow-sm bg-white dark:bg-gray-800">
